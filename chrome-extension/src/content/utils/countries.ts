...
function getCountryCode(countryName: string): keyof typeof isoCountries | undefined {
  for (const prop in isoCountries) {
    if (isoCountries[prop as keyof typeof isoCountries] === countryName) {
      return prop as keyof typeof isoCountries
    }
  }
}
