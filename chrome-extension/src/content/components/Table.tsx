...
export default function Table({ data }: { data: Offer[] }) {
  ...
  return (
    <DataTable
      ...
      loadingText={
        isFormatingOffers ? 'Processing the offers... (it should take less than 2 minutes)' : 'Loading the offers...'
      }
      records={records}
      ...
      totalRecords={filteredData.filter((offer) => !isOfferHidden(offer)).length}
